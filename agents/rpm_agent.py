...
from reputation_management_system import (
    get_google_reviews, get_facebook_reviews, get_yelp_reviews
)
...
available_actions = {
    ...
    'get_facebook_reviews': get_facebook_reviews,
    'get_yelp_reviews': get_yelp_reviews,
    'sikka_api_csv': sikka_api_csv
}

def generate_reputation_management_response(user_question, system_prompt):
