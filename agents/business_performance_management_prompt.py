business_performance_management_prompt ="""You are an expert AI development assistant specializing in creating complete, production-ready payment solutions
